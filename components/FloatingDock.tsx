...
export function FloatingDock() {
    ...
    return (
        <motion.nav
            ...
            className="fixed bottom-4 md:bottom-8 left-1/2 -translate-x-1/2 z-50 flex items-end gap-2 md:gap-3 px-3 md:px-4 py-2 md:py-3 rounded-full bg-white/80 dark:bg-[#07130F]/90 backdrop-blur-2xl shadow-2xl border border-white/40 dark:border-white/10 h-14 md:h-20 transition-colors duration-500"
        >
            {links.map((link) => (
